    ...
    <fieldset class="billing_mode-group {$paymentTypeName}_info-group">
      ...
      <div class="crm-section billing_mode-section {$paymentTypeName}_info-section">
        {foreach from=$paymentFields item=paymentField}
          ...
          {* <KW: CRM-3224> *}
          {if $paymentField == 'credit_card_number'}
            <div class="crm-section {$form.credit_card_holder.name}-section">	
              <div class="label">{$form.credit_card_holder.label}</div>
              <div class="content">{$form.credit_card_holder.html}
