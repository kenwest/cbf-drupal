...
<div class="crm-accordion-wrapper crm-plain_text_email-accordion collapsed">
    ...
    {/if}
          ...
          <tr><td class="label">{ts}Text Version:{/ts}</td><td><iframe height="500" src="{$preview.text_link}" width="750"><a href="{$preview.text_link}" onclick="window.open(this.href); return false;">{ts}Text Version{/ts}</a></iframe></td></tr>
          {/if}
          {if $preview.html_link}
          <tr><td class="label">{ts}HTML Version:{/ts}</td><td><iframe height="500" src="{$preview.html_link}" width="750"><a href="{$preview.html_link}" onclick="window.open(this.href); return false;">{ts}HTML Version{/ts}</a></iframe></td></tr>
          {/if}
        </table>
